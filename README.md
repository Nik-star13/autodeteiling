...
🚗 **AutoDet Service** — веб-приложение автосервиса, где клиенты создают заказы на мойку, шиномонтаж и химчистку через REST API. Администратор управляет заявками через удобную панель, видит новые заказы, детали услуг и общую сумму. Полнофункциональное Spring Boot приложение для управления заказами автосервиса с REST API, админ-панелью и JPA.
